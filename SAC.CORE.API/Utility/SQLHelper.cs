...
namespace SAC.CORE.API.Utility
{
    public class SQLHelper
    {
        private static string CONNECTION_STRING = getConnection();

        private static string CONNECTION_STRING_ADMIN = getConnectionAdmin();
        public static string ConnectionString { get { return CONNECTION_STRING; } }
        public static string ConnectionStringAdmin { get { return CONNECTION_STRING_ADMIN; } }
        ...
        public static string getConnectionAdmin()
        {
            var builder = new ConfigurationBuilder()
               .SetBasePath(Directory.GetCurrentDirectory())
               .AddJsonFile("appsettings.json");
            ...
            return connectionStringConfig.GetConnectionString("AdminConnection");
        }
    }
}