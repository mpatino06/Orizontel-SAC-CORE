...
namespace SAC.CORE.WEB.Infrastructure
{
    public sealed class NumLetras
    {
        ...
        public NumLetras(Boolean ConvertirDecimales, String MascaraSalidaDecimal, String SeparadorDecimalSalida, Boolean LetraCapital)
        {
        ...
        #endregion Conversores de instancia
        ...
        {
            return NumLetras.ToCardinal(Numero, CultureInfo.CurrentCulture);
        }
        ...
        #endregion Conversores estáticos
